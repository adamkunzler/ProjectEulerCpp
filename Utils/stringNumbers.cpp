...
// ---------------------------------------------------------------------------------------------------------------------------
//
// Functions to work with numbers represented by strings. E.g. "123". Allows working with large numbers
//
// charToInt				=> convert a char to an int
// intToChar				=> convert an int to a char
// lambdaStringDigitsSum 	=> sums the digits of a number
...
// usage: std::accumulate(num.begin(), num.end(), 0, lambdaStringDigitsSum)
//
...
//
// calculate base ^ power for numbers represented as strings
//
